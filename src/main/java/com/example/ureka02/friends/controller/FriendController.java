...
public class FriendController {
    ...
    public ResponseDto<Boolean> acceptFriendRequest(@PathVariable Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public ResponseDto<Boolean> rejectFriendRequest(@PathVariable Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public ResponseDto<Boolean> deleteFriend(@PathVariable Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
